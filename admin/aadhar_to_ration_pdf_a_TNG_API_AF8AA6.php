...
$price = mysqli_fetch_assoc(mysqli_query($ahk_conn, "SELECT * FROM pricing WHERE service_name='aadhar_to_ration_pdf_fee' "));
$fee = $price['price'];

if ($_POST['aadhar'] && $_POST['rationtype']) {
    $aadhar = $_POST['aadhar'];
                                        ...
                                        <?php if ($resdata['sampleCode'] === "200") { ?>
                                            <div class="col-lg-8 col-md-6 col-sm-6">
                                                <div class="card" style="background-color: #E8F6F3;">
                                                    <div class="card-body">
                                                        <h5 class="mb-3">Aadhar To Ration  Details</h5>
