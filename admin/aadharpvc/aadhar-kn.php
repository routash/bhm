...
p.download-date.issue {
    ...
    <body>
        <div class="pdf">
            <div class="left">
                <div class="one">
                    <img src="images/kn/img38.jpg">
                    <p> ದಾಖಲಾತಿ ಸಂಖ್ಯೆ / Enrollment No: 1384/14524/0152<?php echo $b['srno']?> </p>
                    <div class="rtt">
...
if ($b['gender']=='MALE'){
  ...
  $sex='F';
   ...
   ?>                   
                ...
                <div class="two">
                    <img src="images/kn/img34.jpg" class="aapka-aadhar">

                    <h3><span><?php echo $b['originalaadharno']?></span></h3>
                    
                    <img src="images/kn/img36.jpg" class="meri-image">
                ...
                <div class="adhr">
                    ...
                    <div class="three">
                        ...
                        <img src="images/kn/img28.jpg" class="img2">
                       <div class="a_lft">
        ...
        <?php } ?>
                    ...
                    <img src="images/kn/img30.jpg" class="img6 image--010">
                </div>
            ...
            <div class="right">
                <div class="one">
                    <img src="images/kn/img29.jpg" class="img4">
                    <?php /*
                    <div class="info">
                        <h4>सूचना</h4>
                        <ul>
                    ...
                    ?>
                    <img src="images/kn/img31.jpg" class="img4">
                ...
                <div class="adhr adhr2">
                    ...
                    <div class="three">
                        <img src="images/kn/img32.jpg" class="img2 img--013">
                        <div class="b_lft">
                            <ul>
                    ...
                    <h3><span><?php echo $b['originalaadharno']?></span></h3>
                    <img src="images/kn/img35.jpg" class="img6">
                </div>
