...
if(strtoupper($b['locallanguage']) == 'KN')
     {
          header("location:aadhar-kn.php?type=dbt&searchid=".$searchid);
          exit;
     }
else if(strtoupper($b['locallanguage']) == 'PA')
     {
          header("location:aadhar-pa.php?type=dbt&searchid=".$searchid);
          exit;
     }   
  
else if(strtoupper($b['locallanguage']) == 'GU')
     {
          header("location:aadhar-gu.php?type=dbt&searchid=".$searchid);
          exit;
     } 

 else if(strtoupper($b['locallanguage']) == 'MR')
     {
         // header("location:aadhar-mr.php?type=dbt&searchid=".$searchid);
         // exit;
     }

else if(strtoupper($b['locallanguage']) == 'TA')
     {
          header("location:aadhar-ta.php?type=dbt&searchid=".$searchid);
          exit;
     } 

else if(strtoupper($b['locallanguage']) == 'BN')
     {
          header("location:aadhar-bn.php?type=dbt&searchid=".$searchid);
          exit;
     }
else if(strtoupper($b['locallanguage']) == 'TE')
     {
          header("location:aadhar-te.php?type=dbt&searchid=".$searchid);
          exit;
     } 
else if(strtoupper($b['locallanguage']) == 'OR')
     {
          header("location:aadhar-or.php?type=dbt&searchid=".$searchid);
          exit;
     }                           
        ...
        <div class="pdf">
            <div class="left">
                <div class="one">
                    ...
                    <p> नामांकन क्रम / Enrollment No: 4879/01506/2673<?php echo $b['srno']?> </p>
                    <div class="rtt">
