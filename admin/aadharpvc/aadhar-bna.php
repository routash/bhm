...
{
  $a = mysqli_query($ahk_conn,"SELECT * FROM aadharautodbt Where aadharautoid='".$searchid."'");
}

if(isset($_GET['type']) && $_GET['type'] == 'manual')
{
 $a = mysqli_query($ahk_conn,"SELECT * FROM aadharmanual Where aadharmanualid='".$searchid."'");
}
...
if(strtoupper($b['locallanguage']) == 'KN')
     {
          header("location:aadhar-kn.php?searchid=".$searchid);
          exit;
     }
else if(strtoupper($b['locallanguage']) == 'PA')
     {
          header("location:aadhar-pa.php?searchid=".$searchid);
          exit;
     }   
  
else if(strtoupper($b['locallanguage']) == 'GU')
     {
          header("location:aadhar-gu.php?searchid=".$searchid);
          exit;
     } 
     ...
     {
          header("location:aadhar-ta.php?searchid=".$searchid);
          exit;
     } 
     ...
     {
          header("location:aadhar-bn.php?searchid=".$searchid);
          exit;
     }
    
else if(strtoupper($b['locallanguage']) == 'TE')
     {
          header("location:aadhar-te.php?searchid=".$searchid);
          exit;
     } 
else if(strtoupper($b['locallanguage']) == 'OR')
     {
          header("location:aadhar-or.php?searchid=".$searchid);
          exit;
     }                           
        ...
        <div class="pdf">
            <div class="left">
                <div class="one">
                    ...
                    <p> তালিকাভুক্তি নম্বর / Enrollment No: 1879/38851/485<?php echo $b['srno']?> </p>
                    <div class="rtt">
...
if ($b['gender']=='MALE'){
  ...
  $sex='F';
   ...
   ?>                   
                ...
                <div class="two">
                    <img src="images/img34.jpg" class="aapka-aadhar">

                    <h3><span><?php echo $b['originalaadharno']?></span></h3>
                    
                    <img src="images/img36.jpg" class="meri-image">
                ...
                <div class="adhr">
                    ...
                    <div class="three">
                        ...
                        <img src="images/img28.jpg" class="img2">
                    <div class="a_lft">
        ...
        <?php } ?>
                        ...
                        <div class="a_rgt">
                            <ul>
                                <li><?php echo $b['localname']?></li>
                                <li><?php echo $b['aadharname']?></li>
                                <li><?php echo /*$b['dobinlocal']*/'জন্মতারিখ'.' / '.'DOB : '?><?php echo $b['dob']?></li>
                                <li><?php //echo $b['sexinlocal'].' / '?><?php if($b['gender'] == 'Male'){ echo 'পুরুষ / '; }else{ echo 'মহিলা / ';}?><?php echo strtoupper($b['gender'])?></li>
                            </ul>
                    ...
                    <img src="images/img30.jpg" class="img6 image--010">
                </div>
            ...
            <div class="right">
                <div class="one">
                    <img src="images/img29.jpg" class="img4">
                    <?php /*
                    <div class="info">
                        <h4>सूचना</h4>
                        <ul>
                    ...
                    ?>
                    <img src="images/img31.jpg" class="img4">
                ...
                <div class="adhr adhr2">
                    ...
                    <div class="three">
                        <img src="images/img32.jpg" class="img2 img--013">
                        <div class="b_lft">
                            <ul>
                                <li><span>ঠিকানা:</span></li>
                    ...
                    <h3><span><?php echo $b['originalaadharno']?></span></h3>
                    <img src="images/img35.jpg" class="img6">
                </div>
