...
p.download-date.issue {
    ...
    <body>
        <div class="pdf">
            <div class="left">
                <div class="one">
                    <img src="images/pa/img38.jpg">
                    <p> ਨਾਮਜਦਗੀ ਨੰਬਰ / Enrollment No: 1538/25874/0052<?php echo $b['srno']?> </p>
                    <div class="rtt">
...
if ($b['gender']=='MALE'){
  ...
  $sex='F';
   ...
   ?>                   
                ...
                <div class="two">
                    <img src="images/pa/img26.jpg" class="aapka-aadhar">

                    <h3><span><?php echo $b['originalaadharno']?></span></h3>
                    
                    <img src="images/pa/img27.jpg" class="meri-image">
                ...
                <div class="adhr">
                    ...
                    <div class="three">
                        ...
                        <img src="images/pa/img33.jpg" class="img2">
           <div class="a_lft">
        ...
        <?php } ?>
                        ...
                        <div class="a_rgt">
                            <ul>
                                <li><?php echo $b['localname']?></li>
                                <li><?php echo $b['aadharname']?></li>
                                <li><?php echo 'ਜਨਮ ਤਿਥੀ/'.'DOB : '?><?php echo $b['dob']?></li>
                                <li><?php echo (($b['gender'] == 'Male')?'ਮਰਦ':'ਔਰਤ')?>/ <?php echo strtoupper($b['gender'])?></li>
                            </ul>
                    ...
                    <img src="images/pa/img34.jpg" class="img6 image--010">
                </div>
            ...
            <div class="right">
                <div class="one">
                    <img src="images/pa/img29.jpg" class="img4">
                    <?php /*
                    <div class="info">
                        <h4>सूचना</h4>
                        <ul>
                    ...
                    ?>
                    <img src="images/pa/img30.jpg" class="img4">
                ...
                <div class="adhr adhr2">
                    ...
                    <div class="three">
                        <img src="images/pa/img35.jpg" class="img2 img--013">
                        <div class="b_lft">
                            <ul>
                                <li><span>ਪਤਾ:</span></li>
                    ...
                    <h3><span><?php echo $b['originalaadharno']?></span></h3>
                    <img src="images/pa/img36.jpg" class="img6">
                </div>
