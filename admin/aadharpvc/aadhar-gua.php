...
p.download-date.issue {
    ...
    <body>
        <div class="pdf">
            <div class="left">
                <div class="one">
                    <img src="images/gu/img38.jpg">
                    <p> નામાંકન ક્રમ સંખ્યા / Enrollment No: 4986/15632/9514 <?php echo $b['srno']?> </p>
                    <div class="rtt">
...
if ($b['gender']=='MALE'){
  ...
  $sex='F';
   ...
   ?>                   
                ...
                <div class="two">
                    <img src="images/gu/img34.jpg" class="aapka-aadhar">

                    <h3><span><?php echo $b['originalaadharno']?></span></h3>
                    
                    <img src="images/gu/img36.jpg" class="meri-image">
                ...
                <div class="adhr">
                    ...
                    <div class="three">
                        ...
                        <img src="images/gu/img28.jpg" class="img2">
                        <div class="a_lft">
        ...
        <?php } ?>
                    ...
                    <img src="images/gu/img30.jpg" class="img6 image--010">
                </div>
            ...
            <div class="right">
                <div class="one">
                    <img src="images/gu/img29.jpg" class="img4">
                    <?php /*
                    <div class="info">
                        <h4>सूचना</h4>
                        <ul>
                    ...
                    ?>
                    <img src="images/gu/img31.jpg" class="img4">
                ...
                <div class="adhr adhr2">
                    ...
                    <div class="three">
                        <img src="images/gu/img32.jpg" class="img2 img--013">
                        <div class="b_lft">
                            <ul>
                                <li><span>સરનામું:</span></li>
                    ...
                    <h3><span><?php echo $b['originalaadharno']?></span></h3>
                    <img src="images/gu/img35.jpg" class="img6">
                </div>
