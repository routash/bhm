		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xl-10 mx-auto">
						<h4> <marquee class="mb-0 text-uppercase">EID TO AADHAAR NUMBER FIND ONLY 24 SE 72 HOURS ME. 100%</marquee></h4>
						<hr/>
							  ...
							  <h6 class="text-danger ">We have found matching duplicates for your enrolment request. If you enrolled in the past and forgotten/lost your Aaadhar number on Enrolment Number, you may retrieve the same by accessing Lost EID/UID" section from our portal (www.uidai.gov.in)."""</h6>
								...
								<form action="" method="POST" class="row g-3">
									...
									<h5 class="text-warning ">Application Fee: <?php  
										$price = mysqli_fetch_assoc(mysqli_query($ahk_conn,"SELECT price FROM pricing WHERE service_name='dublicate_uid'")); 
										echo "₹" .$price['price'];
										?></h5>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="mb-0">All EID TO AAHDAAR NO FIND LIST</h5>
                    </div>
...
$res = mysqli_query($ahk_conn,"SELECT * FROM aadhaar_no WHERE appliedby='".$udata['phone']."' AND purpose='Duplicates' ORDER BY id DESC");
