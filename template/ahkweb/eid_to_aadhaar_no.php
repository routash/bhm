			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xl-10 mx-auto">
						<h4> <marquee class="mb-0 text-uppercase">EID TO AADHAAR NUMBER FIND ONLY 20 MINUTES ME.</marquee></h4>
						<hr/>
...
$res = mysqli_query($ahk_conn,"SELECT * FROM aadhaar_no WHERE appliedby='".$udata['phone']."' AND purpose='Generated' ORDER BY id DESC");
