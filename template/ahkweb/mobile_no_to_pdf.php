		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xl-10 mx-auto">
					    <h6 class="mb-0 text-uppercase">MOBILE NO TO AADHAAR PDF FIND   <a href="https://myaadhaar.uidai.gov.in/retrieve-eid-uid" target="_blank" class="btn btn-success">Check Aadhaar Before Apply</a></h6>
						<hr/>
							...
							<div class="card-body p-5">
								...
								<form action="" method="POST" class="row g-3">
									...
									<div id="maineid" class="col-md-4">
										<label for="inputLastName" class="form-label">REGISTERED MOBILE NO</label>
										<input name="phone" type="text" id="phone" maxlength="10" data-inputmask="'mask': '99999 99999'"   placeholder="Enter 10 Digit Mobile no" class="form-control" >
									</div>

									<div class="col-12 ml-2">
									<h5 class="text-warning ">Application Fee: <?php  
										$price = mysqli_fetch_assoc(mysqli_query($ahk_conn,"SELECT price FROM pricing WHERE service_name='mobile_no_to_pdf'")); 
										echo "₹" .$price['price'];
										?></h5>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="mb-0">All MOBILE TO AAHDAAR PDF FIND LIST</h5>
                    </div>
...
$res = mysqli_query($ahk_conn,"SELECT * FROM mobile_no_to_pdf WHERE appliedby='".$udata['phone']."'  ORDER BY id DESC");
