...
<?php
$res = mysqli_query($ahk_conn,"SELECT * FROM complaint_data  ORDER BY id DESC");
                    ...
                    if($data['status']=="pending"){
                       ...
                       <div style="width:250px;">
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <input class="form-control mb-2" type="text" id="aadh" data-inputmask="'mask': '9999 9999 9999'"  name="aadhaar_no" required placeholder="Enter Aadhaar No">
