        ...
        <div class="card radius-10">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="mb-0">All L.L TEST LIST</h5>
                    </div>
...
<?php
$res = mysqli_query($ahk_conn,"SELECT * FROM lltext  ORDER BY id DESC");
                    ...
                    if($data['status']=="pending"){
                       ...
                       <div style="width:250px;">
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <input class="form-control mb-2" type="text" name="massage" required maxlength="30" placeholder="Enter Your Massage">
