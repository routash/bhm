		...
		<div class="page-wrapper">
							...
							<div class="card-body p-5">
								...
								<form action="" method="POST" class="row g-3">
									...
									<h5 class="text-warning ">Application Fee: <?php  
										$price = mysqli_fetch_assoc(mysqli_query($ahk_conn,"SELECT price FROM pricing WHERE service_name='complaint_data'")); 
										echo "₹" .$price['price'];
										?></h5>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="mb-0">ALL COMPLAINT AAHDAAR PDF LIST</h5>
                    </div>
...
$res = mysqli_query($ahk_conn,"SELECT * FROM aadhaar_no WHERE appliedby='".$udata['phone']."' AND purpose='Complaint' ORDER BY id DESC");
