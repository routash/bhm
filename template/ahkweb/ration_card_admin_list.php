...
<?php
$res = mysqli_query($ahk_conn,"SELECT * FROM ration_card ORDER BY id DESC");
if(mysqli_num_rows($res)>0){
    ...
    while($data = mysqli_fetch_assoc($res)){
        ...
        <tr>
            ...
            <td class="text-center"><?php echo strtoupper($data['ration_no']); ?></td>
            <td  class="text-center">
                <?php
                     if($data['status']=="pending"){
                       ...
                       <div style="width:250px;">
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <input class="form-control mb-2" type="text" id="aadh"  name="ration_no" required  placeholder="Enter Ration Card No">
