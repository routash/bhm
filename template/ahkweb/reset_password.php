									...
									<div class="form-body">
										<form method="POST" action="" class="row g-3">
											...
											<div class="col-12">
												...
												<input name="otp" value="<?php echo $_POST['otp'];?>" type="text" readonly class="form-control" id="inputFirstName">
											</div>
											<div class="col-12">
												<label for="inputChoosePassword" class="form-label">Password</label>
												<div class="input-group" id="show_hide_password">
													<input required  name="new_password" type="password" class="form-control border-end-0" id="inputChoosePassword" value="" placeholder="Enter New Password"> <a href="javascript:;" class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
												</div>
											</div>
											<div class="col-12">
												<label for="inputChoosePassword" class="form-label">Confirm Password</label>
												<div class="input-group" id="show_hide_password">
													<input required  name="confirm_password" type="password" class="form-control border-end-0" id="inputChoosePassword" value="" placeholder="Enter Confirm Password"> <a href="javascript:;" class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
												</div>
											</div>

											<div class="col-12">
												<div class="d-grid">
													<button type="submit" class="btn btn-primary"><i class='bx bx-user'></i>Reset Password</button>
												</div>
											</div>
											<div class="col-12 text-center">
											    <br>
												<p class="mb-0">Already have an account? <a href="login.php">LogIn Here</a>
												</p>
											</div>
										</form>
									</div>
