...
<?php
   ...
   if (isset($_POST['find'])) {
    ...
    if($udata['balance']>=$price['price']){
            $api_hkb = base64_encode("EsMiqyzv-33Zk-XioQ-Pr7G-wh8rUllwlmSSh0p7"); // Buy APi From This Website https://apizone.online ( Design & Development By KPS )
            $url = "https://test.axenapi.co.in/pan_find_api/pan_data_save.php?api_key=$api_hkb&aadhaar_no=$aadhaar&application_no=$application_no";
            $curl = curl_init();
