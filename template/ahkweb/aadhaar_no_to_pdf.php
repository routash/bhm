		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xl-10 mx-auto">
						<h6 class="mb-0 text-uppercase">AADHAAR TO PDF FIND</h6>
						<hr/>
						...
						<div class="card border-top border-0 border-4 border-primary">
							<div class="card-body p-5">
								<div class="card-title d-flex align-items-center">
									...
									<h5 class="mb-0 text-primary">Enter Aadhaar Details</h5>
								</div>
								<hr>
								<form action="" method="POST" class="row g-3">
									...
									<div id="maineid" class="col-md-4">
										<label for="inputLastName" class="form-label">Aadhaar Number</label>
										<input name="uid" type="text" id="phone" maxlength="12" data-inputmask="'mask': '9999 9999 9999'"   placeholder="Enter 12 Digit Aadhaar no" class="form-control" >
									</div>

									<div class="col-12 ml-2">
									<h5 class="text-warning ">Application Fee: <?php  
										$price = mysqli_fetch_assoc(mysqli_query($ahk_conn,"SELECT price FROM pricing WHERE service_name='aadhaar'")); 
										echo "₹" .$price['price'];
										?></h5>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="mb-0">AAHDAAR NO TO PDF LIST</h5>
                    </div>
                        ...
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="text-center">Name</th>
                                 <th class="text-center">UID Number</th>
...
$res = mysqli_query($ahk_conn,"SELECT * FROM aadhaar WHERE appliedby='".$udata['phone']."'  ORDER BY id DESC");
if(mysqli_num_rows($res)>0){
    ...
    while($data = mysqli_fetch_assoc($res)){
        ...
        <tr>
            ...
            <td class="text-center"><?php echo strtoupper($data['uid']); ?></td>
