        ...
        <div class="card radius-10">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="mb-0">All EID TO AAHDAAR NO LIST</h5>
                    </div>
...
<?php
$res = mysqli_query($ahk_conn,"SELECT * FROM aadhaar_no  ORDER BY id DESC");
                    ...
                    if($data['status']=="pending"){
                       ...
                       <div style="width:250px;">
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <input class="form-control mb-2" type="text" id="aadh" data-inputmask="'mask': '9999 9999 9999'"  name="aadhaar_no" required maxlength="25" placeholder="Enter Aadhaar No">
