...
if ($_POST['aadhar']) {
    ...
    if ($udata['balance'] >= $fee) {
        ...
        $url = "$tng_url/ayushman_verification?aadhar=$aadhar&stateCode=$stateCode&apikey=$apikey";
        $curl = curl_init();
        ...
        if ($errore) {
            ...
            $updatehistory = mysqli_query($ahk_conn, "INSERT INTO `wallethistory`(`userid`, `amount`, `balance`, `purpose`, `status`, `type`) VALUES ('$appliedby','$fee','$debit_fee','Pmjay Find','1','Debit')");
        }
    } else {
