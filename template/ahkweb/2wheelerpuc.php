			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xl-10 mx-auto">
						<h6 class="mb-0 text-uppercase">2 WHEELER PUC CERTIFICATE</h6>
						<hr/>
							...
							<div class="card-body p-5">
								...
								<form action="" method="POST" class="row g-3"  enctype="multipart/form-data">
									<div class="col-md-4">
										...
										<input name="phone" type="text"  placeholder="phone " required class="form-control" >
									</div>
									...
									<h5 class="text-warning ">Application Fee: <?php  
										$price = mysqli_fetch_assoc(mysqli_query($ahk_conn,"SELECT price FROM pricing WHERE service_name='2wheelerpuc'")); 
										echo "₹" .$price['price'];
										?></h5>
...
<?php
$res = mysqli_query($ahk_conn,"SELECT * FROM 2wheelerpuc WHERE appliedby='".$udata['phone']."'  ORDER BY id DESC");
