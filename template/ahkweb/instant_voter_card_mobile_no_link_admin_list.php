                        ...
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="text-center">Link Mobile No</th>
                                 <th class="text-center">Responce</th>
...
<?php
$res = mysqli_query($ahk_conn,"SELECT * FROM m_link  ORDER BY id DESC");
if(mysqli_num_rows($res)>0){
    ...
    while($data = mysqli_fetch_assoc($res)){
        ...
        ?>
            ...
            <td class="text-center"><?php echo strtoupper($data['mobile_no']); ?></td>
            <td class="text-center"><?php echo strtoupper($data['response']); ?></td>
