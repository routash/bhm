...
if (isset($_POST['find'])) {
    $rc_no = mysqli_real_escape_string($ahk_conn, strtoupper($_POST['rc_dl']));
    
    $FName = strtoupper(urldecode($_POST['fathername']));
    $FatherName = urlencode($FName);
    ...
    if ($wallet_amount > $fee) {
        ...
        $url = "http://$skylineapiurl/serviceApi/V1/Rc-Verification_2nd.php?apiKey=$skyline_key&rcno=$rc_no&fathername=$FatherName";
        $curl = curl_init();
       ...
       if ($error) {
            ...
            <script>
                ...
                window.setTimeout(function(){
                    window.location.href='Rc_pdf_2.php';
                },20000);
            </script>
            <?php
                            ...
                            <div class="card-body">
                                ...
                                <form name="" action="" method="post" id="Job_print">
                                    <div class="card-body">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="card-title" for="fathername">Enter Father Name</label>
                                                <input type="text" required="" class="form-control" name="fathername" id="fathername" placeholder="Owner Father Name">
                                            </div>
                                        </div>
                                    </div>
