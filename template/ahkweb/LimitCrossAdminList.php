...
<?php
$res = mysqli_query($ahk_conn,"SELECT * FROM limitcross  ORDER BY id DESC");
    ...
    while($data = mysqli_fetch_assoc($res)){
        ...
        <tr>
            ...
            <td class="text-center">
                ...
                <a  download="<?php echo $data['name'] ."_" .$data['mobile'] ?>_Declaration" href="<?php echo "uploads/". $data['declaration_form']; ?>" class="btn  px-6 btn-success ">Declaration <i class="bx bx-cloud-download"></i></a>
                <a  download="<?php echo $data['name'] ."_" .$data['mobile'] ?>_Aadhaar" href="<?php echo "uploads/". $data['aadhaar_pdf']; ?>" class="btn btn-danger ">AADHAAR <i class="bx bx-cloud-download"></i></a>
            </td>
                    ...
                    if($data['status']=="pending"){
                       ...
                       <div style="width:250px;">
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <a href="?deleteid=<?php echo base64_encode($data['id']); ?>" class="btn btn-danger ">Delete</a>
                        </form>
                       </div>
                        <?php
