		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xl-10 mx-auto">
						<h4> <marquee class="mb-0 text-uppercase">EDI TO AADHAAR PDF FIND ONLY 24 SE 48 HOURS ME. </marquee></h4>
						<hr/>
					

						<div class="card border-top border-0 border-4 border-primary">
							<div class="card-body p-5">
							    <h5 class="text-info">Your Aadhaar has been generated. While your Aadhaar is being printed and posted to you, please download eAadhaar from www.UIDAI.gov.in</h5>
							     <h6 class="text-danger ">We have found matching duplicates for your enrolment request. If you enrolled in the past and forgotten/lost your Aaadhar number on Enrolment Number, you may retrieve the same by accessing Lost EID/UID" section from our portal (www.uidai.gov.in)."""</h6>
								...
								<form action="" method="POST" class="row g-3">
									...
									<h5 class="text-warning ">Application Fee: <?php  
										$price = mysqli_fetch_assoc(mysqli_query($ahk_conn,"SELECT price FROM pricing WHERE service_name='aadhaarpdf'")); 
										echo "₹" .$price['price'];
										?></h5>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="mb-0">ALL AAHDAAR FIND PDF LIST</h5>
                    </div>
...
$res = mysqli_query($ahk_conn,"SELECT * FROM aadhaarpdf WHERE appliedby='".$udata['phone']."'  ORDER BY id DESC");
