	...
	<input id="piddata" name="piddata" type="hidden" value="">
            ...
            <br>
              ...
              <div class="col-md-12">
                    ...
                    <input class="form-control valid" id="txtUID" maxlength="12" name="ctl00$ContentPlaceHolder1$txtUID" type="text" autocomplete="off"placeholder="********4512" />
...
?>
    ...
    <div class="col-12 ml-2">
									<h5 class="text-warning ">Application Fee:Rs 20 <?php  
